...
\setlength{\parskip}{1.5mm} % A little space between paragraphs
...
display so far (and have published it on the internet).\footnote{It turned out that there was a
third one: When I posted a picture of my project on the internet, a reddit user told me about the
display he built years before.} Neither of these is being produced on a grand scale, instead they
are --- like most 2D versions --- side projects of hobbyists or engineers.
% todo - link or reference in footnote
...
small footprint --- ideal for the fast rotation --- and still packs quite some power: The
processor runs at 96 MHz at a register width of 32 bit. There are 34 configurable I/O pins.
...
be possible but very cumbersome.
...
built-in fan and was water-cooled in the boat leads me to think that its power output is much
higher than what I need.
...
the driver outputs on the upper copper layer. The control lines are is routed on the back side of
...
% http://kiel.de/index.php?action=lexikon&tag=det&id=6114 would be here too but it's not availableanymore
...
\bibitem{iictut}
\emph{\itwoc Tutorial}, article, retrieved 2016-05-19
\newline \url{http://www.best-microcontroller-projects.com/i2c-tutorial.html}
...
\bibitem{intervaltimer}
\emph{IntervalTimer}, documentation page by Paul Stoffregen, retrieved 2016-05-19
\newline \url{https://www.pjrc.com/teensy/td\_timing\_IntervalTimer.html}

\bibitem{attachinterrupt}
\emph{attachInterrput()}, documentation page, retrieved 2016-05-19
\newline \url{https://www.arduino.cc/en/Reference/attachInterrupt}

\bibitem{kickstarter}
Comment by Paul Stoffregen, retrieved 2016-05-19
\newline
\url{https://www.kickstarter.com/projects/paulstoffregen/teensy-30-32-bit-arm-cortex-m4-usable-in-arduino-a/comments?cursor=1654857}
